...
/**
 * Exit Built-in Command - Terminate the program with a specified status.
 * @data: Structure holding program data.
 * Return: 0 if successful, or a different number if specified as an argument.
 */
int builtin_exit(data_of_program *data)
{
    ...
    {
        /* Verify if the argument is a numeric value */
...
/**
 * Change Directory Built-in Command - Modify the current working directory.
...
/**
 * Set Working Directory - Set the current working directory.
 * @data: Structure containing program data.
...
/**
 * Help Built-in Command - Display help information for built-in commands.
 * @data: Structure containing program data.
 * Return: 0 if successful, or a different number if specified as an argument.
 */
...
/**
 * Alias Built-in Command - Manage aliases by adding, removing, or showing them.
 * @data: Structure containing program data.
 * Return: 0 if successful, or a different number if specified as an argument.
 */
